...
def build_model():
    ...
    # my computer took too long for this to work reliably so was unable to complete it. 
    # After 3 days trying to get this to work, I gave up as was not feasible to perform with losing connections and taken more than 1 hour to run unless it was the simplest of tasks. Here are some of the ideas thought about and tried
    #parameters = {
    ...
    model = GridSearchCV(pipeline, param_grid = parameters, cv=3, scoring='accuracy')
