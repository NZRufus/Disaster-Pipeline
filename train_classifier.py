...
def build_model():
    ...
    # After 5 days trying to get this to work, I gave up as was not feasible to perform with losing connections and taken more than 1 hour to run unless it was the simplest of tasks. Here are some of the ideas thought about and tried
    #parameters = {
